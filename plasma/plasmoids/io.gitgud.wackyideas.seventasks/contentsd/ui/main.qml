...
PlasmoidItem {
    ...
    Layout.preferredWidth: tasks.vertical ? Kirigami.Units.gridUnit * 10 : ((LayoutManager.logicalTaskCount() * LayoutManager.preferredMaxWidth()) / LayoutManager.calculateStripes());
    Layout.preferredHeight: tasks.vertical ? ((LayoutManager.logicalTaskCount() * LayoutManager.preferredMaxHeight()) / LayoutManager.calculateStripes()) : Kirigami.Units.gridUnit * 2;
    //END TODO

    property alias iconsOnly: tasks.iconsOnly
