...
PlasmaCore.Dialog {
    ...
    readonly property int contentWidth: scrollArea.overflowing ? mainItem.width - (Kirigami.Units.smallSpacing * 3) : mainItem.width
    ...
    mainItem: MouseHandler {
        ...
        // idfk what this does but i sure do hope it's nothing important (clueless)
//         PlasmaExtras.ScrollView {
//             id: scrollArea
//
//             anchors.fill: parent
//
...
//             }
    ...
    //         }
    //
    //         maxHeight = groupRepeater.count * (LayoutManager.verticalMargins() + Math.max(theme.mSize(theme.defaultFont).height, Kirigami.Units.iconSizes.medium));
    //
    //         maxWidth += LayoutManager.horizontalMargins() + Kirigami.Units.iconSizes.medium + 2 * Kirigami.Units.smallSpacing;
    //
    ...
    //         }
    //         // FIXME TODO HACK BEGIN END the colors on kate are pretty woaaaaaa
    //         // woaaa
    //         // woaaa
    //         // woaaa
    //         // woaaa
