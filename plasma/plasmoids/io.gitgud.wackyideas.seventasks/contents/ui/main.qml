...
PlasmoidItem {
    ...
    property bool iconsOnly: !Plasmoid.configuration.showLabels && milestone2Mode //Plasmoid.pluginName === "org.kde.plasma.icontasks"

    // Milestone 2 mode settings
    property bool milestone2Mode: parent.height == 40 ? true : false
    property bool showJumplistBtn: Plasmoid.configuration.jumplistArrow
