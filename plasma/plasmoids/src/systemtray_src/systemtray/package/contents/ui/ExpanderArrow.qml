...
PlasmaCore.ToolTipArea {
    ...
    mainText: root.hiddenItemsVisible ? i18n("Hide hidden icons") : i18n("Show hidden icons")
    ...
    MouseArea {
        ...
        hoverEnabled: true
        onClicked: root.hiddenItemsVisible = !root.hiddenItemsVisible;
    }
    ...
    KSvg.SvgItem {
        ...
        imagePath: Qt.resolvedUrl("svgs/systray.svg")
        elementId: root.hiddenItemsVisible ? "collapse" : "expand"
    }
}
