...
import io.gitgud.catpswin56.vtpootb
...
Window {
    ...
    StackLayout {
        ...
        BasicPage {
            pageTitle: i18n("VistaThemePlasma Setup Wizard")
            QQC2.Label {
                text: i18n("Welcome to the VistaThemePlasma first time setup wizard.")
                font.family: "Segoe UI"
            }
            Item {
        ...
        BasicPage {
            ...
            QQC2.Label {
                ...
                font.family: "Segoe UI"
                text: i18n("VistaThemePlasma will change the look and feel of the following parts of your system:\n" +
                           "- Plasma Style\n- Application Style\n- Color Scheme\n- Icon and Sound Theme\n- Window Effects and Animations\n\n" +
                           "To review these changes in detail, see the [install guide](https://gitgud.io/catpswin56/vistathemeplasma/-/blob/master/INSTALL.md?ref_type=heads). These settings can be changed later at any time.")
            }
            Item {
                Layout.fillHeight: true
            }
        ...
        BasicPage {
            ...
            QQC2.Label {
                ...
                wrapMode: Text.WordWrap
                textFormat: Text.MarkdownText
                text: i18n("VistaThemePlasma will change the look and feel of the login screen (SDDM), as well as synchronize settings between Plasma and SDDM.\n")
            }
            Item {
                Layout.fillHeight: true
            }
        ...
        BasicPage {
            ...
            QQC2.Label {
                ...
                wrapMode: Text.WordWrap
                textFormat: Text.MarkdownText
                text: i18n("VistaThemePlasma will change the default cursor theme globally in order for SDDM to recognize it.\n")
            }
            Item {
                Layout.fillHeight: true
            }
        ...
        BasicPage {
            pageTitle: i18n("Completing the VistaThemePlasma Setup Wizard")
            buttonText: i18n("Finish")
            QQC2.Label {
                text: i18n("Thank you for trying out VistaThemePlasma!")
                font.family: "Segoe UI"
            }
            QQC2.Label {
                text: i18n("Click Finish to exit the VistaThemePlasma wizard.")
                font.family: "Segoe UI"
            }
            onNext: {
