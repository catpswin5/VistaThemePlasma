...
MouseArea {
    ...
    //     blendGradient.visible = true
    //     borderRect.visible = true
    //     tempFrame.prefix = "hover"
    // }
    // onExited: {
    //     hoverGradient.visible = false
    //     blendGradient.visible = false
    //     borderRect.visible = false
    //     tempFrame.prefix = "normal"
    // }
    ...
    property bool menuOpen: false // DO NOT SET TO TWRUE!!!!!!!1!!
    ...
    onSmartLauncherEnabledChanged: {
        if (smartLauncherEnabled && !smartLauncherItem) {
            var smartLauncher = Qt.createQtruemlObject("
    import org.kde.plasma.private.taskmanager 0.1 as TaskManagerApplet;
    ...
    KSvg.FrameSvgItem {
        ...
        anchors {
            ...
            leftMargin: ((inPopup || tasks.vertical) && taskList.columns > 1) ? Kirigami.Units.smallSpacing / 4 : Kirigami.Units.smallSpacing / 4
            rightMargin: ((inPopup || tasks.vertical) && taskList.columns > 1) ? Kirigami.Units.smallSpacing / 4 : Kirigami.Units.smallSpacing / 4
        }
        Rectangle {
            z: 2
            ...
            width: childCount == 0 ? 0 : Kirigami.Units.smallSpacing * (childCount >= 3 ? 2 : 1.2)
            opacity: 0.1
            anchors.bottomMargin: 1
            anchors.topMargin: 1
            color: "black"
            visible: stackFirst.visible
        }
        KSvg.FrameSvgItem {
            id: stackFirst
            z: 2
            ...
            anchors.fill: parent
            anchors.rightMargin: Kirigami.Units.smallSpacing * (childCount >= 3 ? 2 : 1.2);
        ...
        Rectangle {
            ...
            visible: (frame.basePrefix === "active-tab") ? false : true
            color: "#22000000";
        ...
        imagePath: (frame.isHovered && frame.basePrefix === "active-tab") ? Qt.resolvedUrl("svgs/tabbar.svgz") : Qt.resolvedUrl("svgs/tasks.svg")//"widgets/tasks"
        ...
        Rectangle {
            ...
            visible: frame.basePrefix === "active-tab" && menuOpen === false ? false : true
    ...
    Item {
        ...
        Kirigami.Icon {
            ...
            anchors.leftMargin: ((pressed) ? Kirigami.Units.smallSpacing / 5 : 0) - ((childCount > 0) ? Kirigami.Units.smallSpacing * ((childCount > 2) ? 2 : 1.2) : 0)
    ...
    PlasmaComponents.Label {
        ...
        visible: false // don't even bother
