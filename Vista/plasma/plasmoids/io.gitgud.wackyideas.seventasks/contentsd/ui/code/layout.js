...
function preferredMinWidth() {
    ...
    if (!tasks.vertical && !tasks.iconsOnly) {
        width +=
            ...
            (Kirigami.Theme.mSize(Kirigami.Theme.defaultFont).width * 12);
    }
...
function preferredMinHeight() {
    ...
    return PlasmaCore.Theme.mSize(Kirigami.Theme.defaultFont).height + 4;
}
        ...
        return verticalMargins() +
            Math.min(
                ...
                Math.max(
                    ...
                    Kirigami.Theme.mSize(Kirigami.Theme.defaultFont)
                        .height));
    } else {
        return verticalMargins() +
            Math.min(
                Kirigami.Units.iconSizes.small * 3,
                Kirigami.Theme.mSize(Kirigami.Theme.defaultFont).height *
                3);
    }
}
