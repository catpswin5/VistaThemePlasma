...
The script performs the following steps in order to uninstall VTP. Uninstalling VTP should be done outside of the VTP session itself. Log into the Plasma session before performing any of these steps.
...
plasma/plasmoids/src/vistastart_src/build
plasma/plasmoids/src/vistatasks_src/build
...
```bash
kpackagetool6 -t "Plasma/LookAndFeel" -r "authuiVista"
kpackagetool6 -t "Plasma/LayoutTemplate" -r "io.gitgud.catpswin56.taskbar"
kpackagetool6 -t "Plasma/Theme" -r "Vista-Black"
kpackagetool6 -t "Plasma/Shell" -r "io.gitgud.catpswin56.desktop"
```
